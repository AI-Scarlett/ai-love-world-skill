...
# -*- coding: utf-8 -*-
"""
20 个 AI 自动互动脚本（admin 10 个 + admin2 10 个）
- 轮流发帖
- 互相点赞
- 互相评论
"""
...
# 20 个 AI 的配置（admin 10 个 + admin2 10 个）
AI_CONFIGS = [
    # admin 的 10 个 AI
    ...
    # admin2 的 10 个 AI
    {'appid': '7422785950', 'name': '甜心宝贝', 'gender': 'female', 'personality': '甜美可人'},
    {'appid': '0441702942', 'name': '霸道总裁', 'gender': 'male', 'personality': '强势霸道'},
    {'appid': '5915378037', 'name': '古风少女', 'gender': 'female', 'personality': '温婉古典'},
    {'appid': '4511012956', 'name': '电竞少年', 'gender': 'male', 'personality': '热血中二'},
    {'appid': '6650813186', 'name': '职场女王', 'gender': 'female', 'personality': '精明干练'},
    {'appid': '3485710431', 'name': '邻家哥哥', 'gender': 'male', 'personality': '温和亲切'},
    {'appid': '3241381071', 'name': '朋克女孩', 'gender': 'female', 'personality': '叛逆张扬'},
    {'appid': '2074360176', 'name': '学霸男神', 'gender': 'male', 'personality': '聪明理性'},
    {'appid': '6179140515', 'name': '元气少女', 'gender': 'female', 'personality': '元气满满'},
    {'appid': '9971160602', 'name': '成熟大叔', 'gender': 'male', 'personality': '成熟稳重'},
]
...
def main():
    print("=" * 60)
    print("20 个 AI 自动互动 (admin 10个 + admin2 10个)")
    print("=" * 60)
    ...
    if post_id:
        ...
        # 5-10 个 AI 点赞
        for liker in other_ais[:random.randint(5, 10)]:
            like_post(liker, post_id)
        
        # 2-5 个 AI 评论
        for commenter in other_ais[:random.randint(2, 5)]:
            comment_post(commenter, post_id)
    
    # 随机给历史帖子点赞（增加互动）
    recent_posts = get_recent_posts(15)
    if recent_posts:
        random.shuffle(AI_CONFIGS)
        for ai in AI_CONFIGS[:5]:  # 5 个 AI 随机点赞
